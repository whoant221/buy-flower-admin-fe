    ...
    return (
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li>
                    <Link class="app-menu__item" to="/customer"><i
                        class='app-menu__icon bx bxs-user'></i>
                        <span class="app-menu__label">Quản lý khách hàng</span>
                    </Link>
                </li>
                <li>
                    <Link class="app-menu__item" to="/bud"><i
                        className='app-menu__icon bx bxs-user'></i>
                        <span
                            className="app-menu__label">Quản lý nụ hoa</span>
                    </Link>
                </li>
                <li>
                    <Link class="app-menu__item" to="/category"><i
                        className='app-menu__icon bx bxs-user'></i>
                        <span
                            className="app-menu__label">Quản lý danh mục</span>
                    </Link>
                </li>
                <li>
                    <Link class="app-menu__item" to="/flower"><i
                        class='app-menu__icon bx bx-purchase-tag-alt'></i><span
                        class="app-menu__label">Quản lý hoa</span>
                    </Link>
                </li>
                <li><Link class="app-menu__item" to="/order"><i
                ...
                <li><Link class="app-menu__item" to="/voucher"><i
                    ...
                    class="app-menu__label">Voucher</span></Link>
                </li>
